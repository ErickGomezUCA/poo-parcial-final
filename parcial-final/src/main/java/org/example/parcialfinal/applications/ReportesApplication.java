...
public class ReportesApplication extends Application {
    ...
    public void start(Stage stage) throws IOException { // 00090123 Método start requerido por la clase Application para iniciar la aplicación
        FXMLLoader fxmlLoader = new FXMLLoader(ReportesApplication.class.getResource("reportes.fxml")); // 00090123 Carga el archivo FXML para la interfaz de usuario de reportes
        ...
        stage.setTitle("Reportes"); // 00090123 Establece el título de la ventana
